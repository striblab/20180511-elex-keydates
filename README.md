# 20180511 Elex Keydates

One-page interactive showing key dates for Minnesota elections.
...
{% block styles %}
  {{ parent() }}
  <link rel="stylesheet" href="{{ static_asset('news/projects/all/20180511-elex-keydates/styles.bundle.css') }}">
{% endblock %}

{% block scripts %}
  {{ parent() }}
  <script type="text/javascript" src="{{ static_asset('news/projects/all/20180511-elex-keydates/app.bundle.js') }}"></script>
{% endblock %}
```
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20180511-elex-keydates/",
      "url": "http://static.startribune.com/news/projects-staging/all/20180511-elex-keydates/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20180511-elex-keydates/",
      "url": "http://static.startribune.com/news/projects/all/20180511-elex-keydates/"
    }
  }
}
```
